...
function initializeTasksPageLogic() {
    ...
    // --- 1. STATE MANAGEMENT ---
    let taskState = [
        { id: 'task1', text: 'Finalize project report', priority: 'high', date: '2025-10-26', completed: false, type: 'task' },
        { id: 'task2', text: 'Call with team', priority: 'medium', date: '2025-10-26', completed: false, type: 'task' },
        ...
        { id: 'task5', text: 'Practice guitar', priority: 'low', date: '2025-10-26', completed: false, type: 'task' },
        { id: 'task6', text: 'Buy groceries', priority: 'low', date: '2025-10-30', completed: false, type: 'task' },
        // Mock Google Calendar Events (Meetings and Holidays)
    ...
    let taskToDeleteId = null; // NEW: Global ID holder for deletion
    ...
    function renderTaskList() {
        ...
        let displayTasks = taskState.filter(task => {
            // Only show user-defined tasks in the list view
        ...
        displayTasks.sort((a, b) => {
            ...
            // Primary Sort: Separate Incomplete/Complete
            ...
            // Default ('date') View: Sort by Date, then by Priority
            ...
            return priorityB - priorityA; // Fallback to Priority (High to Low)
        });
        // -------------------------------------------------------
        ...
        mainTaskList.querySelectorAll('.delete-task-button').forEach(button => {
            button.addEventListener('click', (e) => {
                // NEW: Use custom themed modal instead of native confirm()
    ...
    // --- 3. "ADD TASK" MODAL LOGIC (Unchanged) ---
    ...
    // --- X. TASK FILTER BAR LOGIC (Unchanged) ---
    ...
    // --- Y. EDIT TASK MODAL LOGIC (Unchanged from last step) ---
    ...
    // --- Z. DELETE CONFIRMATION MODAL LOGIC (NEW) ---
    ...
    // --- 4. "DAY TASKS" MODAL LOGIC (Unchanged) ---
